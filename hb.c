 ...
 *
 * Uncomment either one of the 2 lines below. Uncomment the prior to disable
 * (any) font features. Uncomment the latter to enable the (selected) font
 * features.
 */

hb_feature_t features[] = {0};
// hb_feature_t features[] = { FEATURE('s','s','0','1'),
// FEATURE('s','s','0','2'), FEATURE('s','s','0','3'), FEATURE('s','s','0','5'),
// FEATURE('s','s','0','6'), FEATURE('s','s','0','7'), FEATURE('s','s','0','8'),
// FEATURE('z','e','r','o') };
